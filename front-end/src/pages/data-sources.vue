...
usePageSeo({
	description: "Ballot Clarity's live data roadmap: official source hierarchy, provider strategy, migration risks, and the backend architecture planned to replace the current demo data layer.",
	path: "/data-sources",
			...
			<header class="gap-8 grid xl:grid-cols-[minmax(0,1.2fr)_minmax(22rem,0.85fr)]">
				<div class="surface-panel">
					<div class="flex flex-wrap gap-2">
						...
						<TrustBadge label="Demo now, live later" tone="warning" />
					</div>
					...
					<p class="bc-prose text-app-muted mt-5 dark:text-app-muted-dark">
						Ballot Clarity currently runs on realistic demo content. This page shows how the site is designed to move to live civic data without pretending there is a single perfect national source. The rule is simple: official sources where they are authoritative, normalized providers where scale matters, and a separate research layer for archives and analytics.
					</p>
