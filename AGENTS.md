...
- Record deployment or environment consequences in the final handoff and, when a pull request is required, in its body
  when a change affects runtime configuration or public API behavior.
