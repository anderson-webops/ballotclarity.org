...
- Admin model: persisted users, content status/history/rollback, correction queue with content-record linkage, and source-health tracking all live behind a protected internal surface
