...
export const themeSchemeDefinitions = [
	{
		...
		modes: {
			dark: {
				...
				"--app-action": "#7ea2ff",
				"--app-action-rgb": "126 162 255",
				"--app-action-strong": "#a3bdff",
				"--app-action-strong-rgb": "163 189 255",
				"--app-action-text": "#0d1117",
				"--app-action-text-rgb": "13 17 23",
				"--app-bg": "#0d1117",
				"--app-bg-dark": "#0d1117",
			...
			light: {
				...
				"--app-action": "#121722",
				"--app-action-rgb": "18 23 34",
				"--app-action-strong": "#1b2b49",
				"--app-action-strong-rgb": "27 43 73",
				"--app-action-text": "#ffffff",
				"--app-action-text-rgb": "255 255 255",
				"--app-bg": "#f4f5f8",
				"--app-bg-dark": "#0d1117",
				"--app-bg-dark-rgb": "13 17 23",
	...
	},
	{
		...
		modes: {
			dark: {
				...
				"--app-action": "#5ac3a8",
				"--app-action-rgb": "90 195 168",
				"--app-action-strong": "#74d5bc",
				"--app-action-strong-rgb": "116 213 188",
				"--app-action-text": "#0d1110",
				"--app-action-text-rgb": "13 17 16",
				"--app-bg": "#0d1110",
				"--app-bg-dark": "#0d1110",
			...
			light: {
				...
				"--app-action": "#121715",
				"--app-action-rgb": "18 23 21",
				"--app-action-strong": "#1b302b",
				"--app-action-strong-rgb": "27 48 43",
				"--app-action-text": "#ffffff",
				"--app-action-text-rgb": "255 255 255",
				"--app-bg": "#f5f4ef",
				"--app-bg-dark": "#0d1110",
	...
	},
	{
		...
		modes: {
			dark: {
				...
				"--app-action": "#e09a64",
				"--app-action-rgb": "224 154 100",
				"--app-action-strong": "#f0b07c",
				"--app-action-strong-rgb": "240 176 124",
				"--app-action-text": "#120f0d",
				"--app-action-text-rgb": "18 15 13",
				"--app-bg": "#120f0d",
				"--app-bg-dark": "#120f0d",
			...
			light: {
				...
				"--app-action": "#1c1613",
				"--app-action-rgb": "28 22 19",
				"--app-action-strong": "#36221a",
				"--app-action-strong-rgb": "54 34 26",
				"--app-action-text": "#ffffff",
				"--app-action-text-rgb": "255 255 255",
				"--app-bg": "#f6f2ed",
				"--app-bg-dark": "#120f0d",
