...
const serviceScope = [
	...
	"Printable or shareable ballot-guide views generated by the site.",
	"Public contact and correction-request pages."
];
...
const legalLimits = [
	"The site is provided on an \"as is\" and \"as available\" basis, and coverage varies by jurisdiction, source availability, and review status.",
...
usePageSeo({
	description: "Terms of Service for Ballot Clarity, covering informational use, coverage limits, permitted public-interest reuse, prohibited conduct, and service disclaimers.",
	path: "/terms",
...
<template>
	<section class="legal-page app-shell section-gap space-y-8">
		...
		<InfoCallout title="Current scope">
			These terms govern the public civic-information site at {{ siteUrl }}. They do not govern separate contracts with upstream providers or any future account, donation, or API products that Ballot Clarity may add later.
		</InfoCallout>
