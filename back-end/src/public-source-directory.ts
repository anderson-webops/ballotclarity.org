...
const curatedSourceDefinitions: CuratedSourceDefinition[] = [
	...
	},
	{
		...
		id: "ctcl-bip",
		limitations: [
			"Direct API or bulk access requires CTCL approval.",
			"Ballot Clarity should still attach official state or county ballot verification before publishing a reviewed local guide.",
		],
		note: "Potential trusted ballot-content backbone once Ballot Clarity has direct access to CTCL Ballot Information Project data.",
		publisher: "Center for Tech and Civic Life",
		publisherType: "public-interest",
		primarySourceLabel: "Open CTCL Ballot Information Project",
		reviewNote: "Ballot Clarity should review this record when CTCL grants data access or changes delivery format.",
		routeCitations: [
			{ href: "/data-sources", id: "data-sources", label: "Data sources", type: "page" },
			{ href: "/results", id: "results", label: "Results", type: "page" },
		],
		sourceSystem: "CTCL Ballot Information Project",
		summary: "Nonprofit ballot-information dataset focused on who and what appears on voter-specific ballots.",
		title: "CTCL Ballot Information Project",
		type: "research brief",
		url: "https://www.techandciviclife.org/our-work/research-department/our-data/ballot-information/",
		usedFor: "Planned ballot-content ingestion, candidate roster normalization, referenda, and OCD-ID-linked ballot geography when access is granted."
	},
	{
		authority: "nonprofit-provider",
		geographicScope: "United States",
		id: "ballotpedia",
		limitations: [
			"Returned fields can depend on Ballotpedia API package terms.",
			"Provider ballot data does not replace official local ballot verification.",
		],
		note: "Optional ballot-content provider for race, candidate, and measure data by point or state/election date.",
		publisher: "Ballotpedia",
		publisherType: "public-interest",
		primarySourceLabel: "Open Ballotpedia API docs",
		reviewNote: "Ballot Clarity should review this record when Ballotpedia API access, package scope, or field mapping changes.",
		routeCitations: [
			{ href: "/data-sources", id: "data-sources", label: "Data sources", type: "page" },
			{ href: "/results", id: "results", label: "Results", type: "page" },
		],
		sourceSystem: "Ballotpedia API",
		summary: "Ballot-content API that can return races, candidates, ballot measures, districts, offices, and person records for configured access.",
		title: "Ballotpedia API",
		type: "research brief",
		url: "https://developer.ballotpedia.org/geographic-apis/elections_by_point",
		usedFor: "Optional provider ballot previews and future reviewed local package ingestion when a Ballotpedia API key is configured."
	},
	{
		authority: "commercial-provider",
		geographicScope: "United States",
		...
		limitations: [
			"Requires partner access, pricing, and licensing review.",
			"Provider-authored profiles or issue content need explicit republication terms before use on public guide pages.",
		],
		note: "Optional commercial ballot and candidate-profile provider if Ballot Clarity chooses a licensed data backbone.",
		publisher: "BallotReady",
		publisherType: "third-party civic infrastructure",
		primarySourceLabel: "Open CivicEngine docs",
		reviewNote: "Ballot Clarity should review this record when CivicEngine access or licensing terms are active.",
		routeCitations: [
			{ href: "/data-sources", id: "data-sources", label: "Data sources", type: "page" },
			{ href: "/results", id: "results", label: "Results", type: "page" },
		],
		sourceSystem: "BallotReady CivicEngine",
		summary: "Commercial civic-data API for ballot matching, candidate profiles, issue content, ballot measures, and voter-guide data.",
		title: "BallotReady CivicEngine",
		type: "research brief",
		url: "https://developers.civicengine.com/docs/api/graphql/reference/objects/ballot-event",
		usedFor: "Optional commercial provider integration for richer ballot guide content if a partnership is approved."
	},
	{
		authority: "nonprofit-provider",
		geographicScope: "United States",
		id: "democracy-works",
		limitations: [
			"API access requires a key from Democracy Works.",
			"Ballot data is not returned by default and is coverage-limited.",
			"Ballot content is sourced from Ballotpedia and should be labeled accordingly.",
		],
		note: "Optional elections API for dates, deadlines, voting guidance, and ballot content where includeBallotData is available.",
		publisher: "Democracy Works",
		publisherType: "public-interest",
		primarySourceLabel: "Open Democracy Works API docs",
		reviewNote: "Ballot Clarity should review this record when Democracy Works API access or ballot-data field mapping changes.",
		routeCitations: [
			{ href: "/data-sources", id: "data-sources", label: "Data sources", type: "page" },
			{ href: "/results", id: "results", label: "Results", type: "page" },
		],
		sourceSystem: "Democracy Works Elections API",
		summary: "Nonprofit elections API for election discovery, dates, deadlines, guidance, and optional ballot data when requested.",
		title: "Democracy Works Elections API",
		type: "research brief",
		url: "https://developers.democracy.works/api/v2",
		usedFor: "Optional election logistics and ballot-data ingestion when a Democracy Works API key is configured."
	},
	{
		authority: "official-government",
